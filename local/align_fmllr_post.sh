...
if $use_graphs; then
  echo "unexpected line 84" && exit 1;
:<<'END'
...
if [ $stage -le 3 ]; then
  ...
  #maxactive=20000; beam=400.0; lattice_beam=7.0; acwt=0.083333;
  #maxactive=40000; beam=400.0; lattice_beam=7.0; acwt=0.083333;
  #maxactive=40000; beam=400.0; lattice_beam=3.0; acwt=0.083333;
  #maxactive=80000; beam=700.0; lattice_beam=3.0; acwt=0.083333;
  $cmd JOB=1:$nj $dir/log/align_pass2.JOB.log \
