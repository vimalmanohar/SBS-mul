...
if [ $stage -le 2 ]; then
  ...
  steps/align_fmllr.sh --nj 40 --cmd "$train_cmd" \
    data/train data/lang exp/tri3b exp/nnet2_online/tri3b_ali
fi
...
if [ $stage -le 4 ]; then
  ...
  steps/online/nnet2/train_diag_ubm.sh --cmd "$train_cmd" --nj 30 \
     --num-frames 400000 data/train_hires 256 exp/nnet2_online/tri4b exp/nnet2_online/diag_ubm
fi
